...
module.exports = function(app) {
 ...
 app.route('/')
	.get(test_controller.home);

  app.route('/control')
	.get(test_controller.home);

  app.route('/control')
	.post(test_controller.saveDevice);

  app.route('/control/add_device')
	.get(test_controller.addDevice);

  app.route('/control/test_device')
	.get(test_controller.testDevice);
